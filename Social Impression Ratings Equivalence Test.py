...
# S1 AND S2 SOCIAL IMPRESSION EQUIVALENCE TEST
# Calculating mean values for Social Impression scores of two groups
s1_mean = df['S1Social_Impression'].mean()
s2_mean = df['S2Social_Impression'].mean()

# Equivalence margin
equivalence_margin = 0.5

# Creating boxplots for the two groups
plt.boxplot([df['S1Social_Impression'], df['S2Social_Impression']], labels=['S1 Audio AI Generated Speech', 'S2 Audio Natural Speech'])
...
plt.title('Social Impression Ratings Equivalence Test of S1 Audio AI Generated Speech and S2 Audio Natural Speech', pad=20)
plt.legend()

plt.show()

# S3 AND S4 SOCIAL IMPRESSION EQUIVALENCE TEST
s3_mean = df['S3Social_Impression'].mean()
s4_mean = df['S4Social_Impression'].mean()

equivalence_margin = 0.5 

plt.boxplot([df['S3Social_Impression'], df['S4Social_Impression']], labels=['S3 Audio AI Generated Speech', 'S4 Audio Natural Speech'])
...
plt.xlabel('Audio')
plt.ylabel('Social Impression Ratings')
plt.title('Social Impression Ratings Equivalence Test of S3 Audio AI Generated Speech and S4 Audio Natural Speech', pad=20)
plt.legend()

plt.show()

# S5 AND S6 SOCIAL IMPRESSION EQUIVALENCE TEST
s5_mean = df['S5Social_Impression'].mean()
s6_mean = df['S6Social_Impression'].mean()

equivalence_margin = 0.5 

plt.boxplot([df['S5Social_Impression'], df['S6Social_Impression']], labels=['S5 Audio Natural Speech', 'S6 Audio AI Generated Speech'])
...
plt.xlabel('Audio')
plt.ylabel('Social Impression Ratings')
plt.title('Social Impression Ratings Equivalence Test of S5 Audio Natural Speech and S6 Audio AI Generated Speech', pad=20)
plt.legend()
